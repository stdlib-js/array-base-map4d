...
```javascript
import map4d from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-map4d@v0.2.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-map4d@v0.2.0-deno/mod.js';
```
